...
void solve(){
    ...
    vector<ll> x = {a[0].second, a[1].second, a[2].second};
    vector<ll> y = {b[0].second, b[1].second, b[2].second};
    vector<ll> z = {c[0].second, c[1].second, c[2].second};
    ll ans = 0;
    for(int i: x){
        for(int j: y){
            for(int k: z){
